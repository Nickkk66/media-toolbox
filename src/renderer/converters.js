...
const ICONS = {
  ...
  spotify: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M7.5 9.5c3-1 7-0.7 9.5 0.8M8 12.5c2.4-0.8 5.5-0.5 7.5 0.7M8.5 15.3c1.9-0.6 4.2-0.4 5.8 0.5"/></svg>',
