...
const ICONS = {
  ...
  spotify: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9.5"/><path d="M7 9.6c3.2-1.1 7.4-0.7 10 1" stroke-width="1.9"/><path d="M7.6 12.7c2.6-0.9 6-0.6 8.2 0.9" stroke-width="1.9"/><path d="M8.2 15.7c2-0.7 4.6-0.5 6.4 0.6" stroke-width="1.9"/></svg>',
...
const TOOL_CATEGORIES = [
  {
    name: 'Video Tools', icon: 'video', items: [
      ...
      { id: 'watermark-remover', label: 'Watermark Remover', engine: 'watermark', accept: IMAGE, tags: ['watermark', 'logo', 'remove', 'erase', 'cleanup', 'brush', 'patch', 'inpaint', 'image'] },
  ...
  },
  {
    name: 'PDF Tools', icon: 'pdf', items: [
      ...
      { id: 'crop-pdf', label: 'Crop PDF', engine: 'pdfcrop', accept: ['pdf'], tags: ['pdf', 'crop', 'trim', 'margins', 'cut', 'document'] },
      { id: 'organize-pdf', label: 'Organize PDF', engine: 'pdforganize', accept: ['pdf'], tags: ['pdf', 'organize', 'reorder', 'rearrange', 'rotate', 'delete pages', 'arrange', 'document'] },
    ],
  },
  {
    name: 'More Tools', icon: 'tools', items: [
      ...
      { id: 'spotify', label: 'Spotify Downloader', engine: 'spotify', tags: ['spotify', 'music', 'song', 'mp3', 'album', 'cover', 'art', 'rip', 'download', 'ipod', 'audio'] },
    ],
  },
];
